...
const RULES_SCHEMA=[
  ...
  {field:'default_type_value',label:'Default Appt Type',type:'text',ph:'Producer, Subproducer, or NA',group:'identity'},
  {field:'type_value_map',label:'Appt Type Map',type:'text',ph:'NULL:Producer|*:Subproducer',group:'identity'},
