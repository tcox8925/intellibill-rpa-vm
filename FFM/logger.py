...
import pandas as pd
import pytz
from db_connection import connect_to_db, get_postgres_connection
import pyodbc
...
def update_log_to_synapse(script_name, start_datetime_str, end_datetime_str, error, success):
    """
