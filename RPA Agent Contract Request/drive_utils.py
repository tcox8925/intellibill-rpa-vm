...
def update_file(service, file_id: str, local_file_path: str) -> str:
    """
    Update a file to the specified Google Drive folder.
    ...
    try:
        ...
        print(f"📤 Updating {file_name} at id {file_id}...")
        ...
        print(f"✅ Updated {file_name} → {link}")
        return link

    except Exception as e:
        print(f"❌ Update failed for {local_file_path}: {e}")
        return None

def delete_file(service, file_id: str) -> str:
    """
    Delete a file to the specified Google Drive folder.
    ...
    """
    try:
        print(f"📤 Deleting file at id {file_id}...")
        deleted = service.files().delete(
            fileId=file_id
        ).execute()
        print(f"✅ Deleted {file_id} → {deleted}")
        return True
...
# root/Contracting/Ambetter: 1HB_Z9RcVXPxgksHqKtkNsC9UhVc3FRdY
# Ambetter Rolling Contract Sheet.xlsx: 1JJ23qy-f7_vNuUK2f6VargRwGAcSFIrB
#svc = get_drive_service()
#download_file('1JJ23qy-f7_vNuUK2f6VargRwGAcSFIrB', 'C:/Users/myopsadmin/Downloads/temp/Ambetter Rolling Contract Sheet.xlsx')
#update_file(svc,'1JJ23qy-f7_vNuUK2f6VargRwGAcSFIrB','C:/Users/myopsadmin/Downloads/temp/Ambetter Rolling Contract Sheet.xlsx')
#results = list_all_files_recursive('1HB_Z9RcVXPxgksHqKtkNsC9UhVc3FRdY')
#print(results)
