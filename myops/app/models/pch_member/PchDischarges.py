...
class PchDischarges(Base):
    __tablename__ = "pch_discharges"
    ...
    discharge_date = Column(Text, nullable=True)
    discharge_code = Column(Text, nullable=True)
    discharge_code_description = Column(Text, nullable=True)
