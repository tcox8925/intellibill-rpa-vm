...
class Pch_Caqh_Practice_Languages(Base):
    __tablename__ = "pch_caqh_practice_languages"
    ...
    language      = Column(NVARCHAR(200), nullable=True)
    type          = Column(NVARCHAR(100), nullable=True)
    employee_type = Column(NVARCHAR(100), nullable=True)
