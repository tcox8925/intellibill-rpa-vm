...
class Pch_Caqh_Provider_Associates(Base):
    __tablename__ = "pch_caqh_provider_associates"
    ...
    npi             = Column(VARCHAR(20), nullable=True, index=True)
    ...
    associate_npi   = Column(VARCHAR(20), nullable=True)
    ...
    def __repr__(self):
        return (
            f"<Pch_Caqh_Provider_Associates(txn_id={self.txn_id}, "
