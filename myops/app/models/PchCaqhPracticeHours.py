...
class Pch_Caqh_Practice_Hours(Base):
    __tablename__ = "pch_caqh_practice_hours"
    ...
    day          = Column(NVARCHAR(50), nullable=True)
    start_time   = Column(NVARCHAR(50), nullable=True)
    end_time     = Column(NVARCHAR(50), nullable=True)
    hours_type   = Column(NVARCHAR(100), nullable=True)
