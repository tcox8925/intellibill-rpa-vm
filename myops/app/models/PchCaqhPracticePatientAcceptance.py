...
class Pch_Caqh_Practice_Patient_Acceptance(Base):
    __tablename__ = "pch_caqh_practice_patient_acceptance"
    ...
    patient_type  = Column(NVARCHAR(200), nullable=True)
    accepts_flag  = Column(BIT, nullable=True)
