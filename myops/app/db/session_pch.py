...
DATABASE_USER = settings.PCH_PG_USER
DATABASE_HOST = settings.PCH_PG_HOST  
DATABASE_PORT = settings.PCH_PG_PORT
DATABASE_NAME = settings.PCH_PG_DATABASE
DATABASE_PASSWORD = settings.PCH_PG_PASSWORD
