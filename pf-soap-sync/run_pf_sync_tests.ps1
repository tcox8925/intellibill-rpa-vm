param(
    ...
    [string]$ChromeUserDataDir = "C:\PFSoapSync\chrome-profile",
...
$Worker = Join-Path $ProjectDir "pf_soap_sync_v5_13.py"
...
$ExpectedBuild = "PF-SOAP-SYNC-v5.13.0-summary-only-appointment-check"
